public class FormateadoresTabla {
    public static void main(String[] args) {
        ...
        System.out.printf("%-15s %-40s %-30s%n", "%.2f", "Número de punto flotante (2 decimales)", String.format("%.2f", 19.999));
        ...
        System.out.printf("%-15s %-40s %-30s%n", "%10s", "Cadena con ancho mínimo de 10 (derecha)", String.format("%10s", "Texto"));
        System.out.printf("%-15s %-40s %-30s%n", "%-10s", "Cadena con ancho mínimo de 10 (izquierda)", String.format("%-10s", "Texto"));
        System.out.printf("%-15s %-40s %-30s%n", "%10.2f", "Punto flotante con ancho de 10 y 2 decimales", String.format("%10.2f", 19.99\n));
        ...
        // %10d: Alinea a la derecha un número entero (cantidad) en un campo de 10 caracteres
        System.out.printf(\n"%-20s %-15s %-10s%n", "Producto", "Precio", "Cantidad");
        System.out.println("-----------------------------------------------");
