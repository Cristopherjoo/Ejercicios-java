public class AritmeticaCompuesta {
	...
	public static void main(String[] args) {
		...
		// 2. Multiplicación *, División / y Módulo % tienen la misma prioridad y se
		// resuelven de izquierda a derecha.
		// 3. Suma + y Resta - tienen menor prioridad y también se resuelven de
		// izquierda a derecha.
